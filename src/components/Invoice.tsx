...
function StatCard({ label, value, sub, icon, color }: {
  ...
  return (
    <div className={`rounded-2xl p-5 border shadow-sm ${color}`}>
...
function RecentRow({ inv, onView }: { inv: Invoice; onView: () => void }) {
  ...
  return (
    <div onClick={onView}
      className="flex items-center justify-between px-4 py-3 hover:bg-gray-50 cursor-pointer rounded-xl transition-colors group">
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-base font-extrabold text-blue-600 shrink-0">
          {inv.client.charAt(0)}
        </div>
        <div>
      ...
      <div className="text-right flex flex-col items-end gap-1">
        <p className="font-extrabold text-gray-800 text-sm">{sym}{inv.totals.grandTotal.toLocaleString()}</p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between py-4">
            ...
            <button onClick={() => setActiveTab("new")}
              className="px-5 py-2.5 bg-blue-600 text-white rounded-xl text-sm font-bold hover:bg-blue-700 shadow-md transition-all flex items-center gap-2">
          ...
          <div className="flex gap-1 overflow-x-auto pb-px">
            {tabs.map(t => (
              <button key={t.id} onClick={() => setActiveTab(t.id)}
                className={`flex items-center gap-1.5 px-4 py-2.5 text-sm font-semibold border-b-2 whitespace-nowrap transition-all
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm">
                <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                  ...
                  <button onClick={() => setActiveTab("invoices")} className="text-xs text-blue-600 hover:underline">View all</button>
                </div>
                <div className="p-2">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <button onClick={() => setActiveTab("new")}
                    className="w-full py-3 border-2 border-dashed border-blue-300 rounded-xl text-blue-600 text-sm font-semibold hover:bg-blue-50 transition-all">
