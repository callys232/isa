    ...
    <div className="mt-3 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      <form onSubmit={submit} className="p-4 space-y-3">
        ...
        <div>
          ...
          <input value={name} onChange={e => setName(e.target.value)} placeholder="e.g. Adaeze Okafor" className={inp} />
        </div>
        <div>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-1.5">
            {[["free","Free","Free"],["pro","Pro","Pro"],["premium","Premium","Best"]].map(([v, l, p]) => (
